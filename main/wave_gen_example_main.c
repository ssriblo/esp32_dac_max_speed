...
*/
//#define INTERRUPT_DAC   1 /* Original code is interrupt gen */
...
#define FREQ                   5*1000// CONFIG_EXAMPLE_WAVE_FREQUENCY        // 3kHz by default
...
void app_main(void)
{
    ...
    while(1) {
            ...
            for(int i=0; i<128; i++){
                    ...
                    // dac_ll_update_output_value(0, 50);
                    // dac_ll_update_output_value(0, 50);
                    // dac_ll_update_output_value(0, 50);
                    // dac_ll_update_output_value(0, 50);
                    // dac_ll_update_output_value(0, 50);
                    ...
                    // dac_ll_update_output_value(0, 150);
                    // dac_ll_update_output_value(0, 150);
                    // dac_ll_update_output_value(0, 150);
                    // dac_ll_update_output_value(0, 150);
                    // dac_ll_update_output_value(0, 150);
